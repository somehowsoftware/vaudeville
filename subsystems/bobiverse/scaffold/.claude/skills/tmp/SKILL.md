...
- "[...] Returning to your point about cross-tenant isolation, the consequence is that the worktree path can't be derived from the Premise id alone. [...]"
- "[...] I still disagree about merging the two Routes, for the constraint you raised at the top of this thread: a `plan` Premise's deliverable is in the tracker, not in a PR. [...]"

Two reasons for the bold-dot form, both load-bearing:
