...
from vaudeville_bobiverse import claude_config, claude_projects
from vaudeville_bobiverse.checkpoint_layout import CheckpointLayout, checkpoint_layout
from vaudeville_bobiverse.checkpoint_plan import (
...
from vaudeville_bobiverse.checkpoint_runner import run_plan
from vaudeville_bobiverse.digest import Section, accumulate, render
from vaudeville_bobiverse.digest_store import deserialize_sections
from vaudeville_bobiverse.operator_turns import operator_turns
from vaudeville_bobiverse.transcript import messages_from_transcript_lines
...
def digest_sections(
    ...
    return accumulate(_prior_sections(prior_store), Section(str(transcript), tuple(turns)))
