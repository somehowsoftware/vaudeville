...
def stand_up_session(
    ...
    *,
    ...
    agent_script = agent.write_agent_script(
        target, worktree, agent.propagated_environment(), prompt_file
    )
    workmux.run_workmux(workmux.workmux_invocation(seeded, worktree, agent_script))
