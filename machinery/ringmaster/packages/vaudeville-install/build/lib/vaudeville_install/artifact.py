"""The Artifact contract: the published shape Build writes and Install reads.

This is the single definition both halves of the deploy speak: the layout the integrator
writes into and the installer reads back from, plus the names that cross the seam.
