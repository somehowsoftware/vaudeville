...
resolves the environment itself; a Host install lands on the real host state (not a Staging
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        dest="config_dir",
        help="the tenant's config dir (project map, credentials, project-docs)",
    )
    parser.add_argument(
