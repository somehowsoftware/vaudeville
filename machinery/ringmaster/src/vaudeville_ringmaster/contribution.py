"""The Contribution: what a Contributor Repo offers to the Host Scaffold."""
...
from vaudeville_ringmaster.manifest import Manifest, read_manifest_at
...
def discover_contribution_in(name: str, source_root: Path) -> Contribution:
    return Contribution(
        ...
        manifest=read_manifest_at(source_root),
